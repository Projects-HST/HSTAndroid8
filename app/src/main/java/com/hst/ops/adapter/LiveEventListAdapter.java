...
public class LiveEventListAdapter extends RecyclerView.Adapter<LiveEventListAdapter.MyViewHolder> {
...
//            }
    ...
    public LiveEventListAdapter(ArrayList<NewsFeed> newsFeedArrayList, OnItemClickListener onItemClickListener) {
    ...
    @Override
    public LiveEventListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_live_events, parent, false);

        return new LiveEventListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(LiveEventListAdapter.MyViewHolder holder, int position) {
