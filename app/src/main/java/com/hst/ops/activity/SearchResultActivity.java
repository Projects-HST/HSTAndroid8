...
public class SearchResultActivity extends AppCompatActivity implements View.OnClickListener, IServiceListener, DialogClickListener, NewsFeedListAdapter.OnItemClickListener {
...
//                }
                ...
                jsonObject.put(OPSConstants.KEY_SEARCH_KEYWORD, PreferenceStorage.getSearchFor(this));
...
//            progressDialogHelper.showProgressDialog(getString(R.string.progress_loading));
            String url = OPSConstants.BUILD_URL + OPSConstants.SEARCH_NEWSFEED;
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent intent = new Intent(this, NewsfeedDetailActivity.class);
